-- AlterTable
ALTER TABLE "Product" ADD COLUMN "shopifyFileId" TEXT;
...
INSERT INTO "new_ProductVariant" ("createdAt", "diamondCategory", "grossWeight", "id", "makingChargeType", "makingChargeValue", "metalColor", "metalId", "productId", "purityId", "shopifyVariantId", "status", "stoneIncluded", "stoneRate", "stoneType", "stoneWeight", "updatedAt", "wastagePercent") SELECT "createdAt", "diamondCategory", "grossWeight", "id", "makingChargeType", "makingChargeValue", "metalColor", "metalId", "productId", "purityId", "shopifyVariantId", "status", "stoneIncluded", "stoneRate", "stoneType", "stoneWeight", "updatedAt", "wastagePercent" FROM "ProductVariant";
